...
queue()
    .defer(d3.json, '/ch3/geography/water/')
    .defer(d3.json, '/ch3/geography/land/')
    .defer(d3.json, '/ch3/geography/cultural/')
    .await(draw);
...
function add_airlines() {
    queue()
        .defer(d3.text, '/ch3/geography/airports/')
        .defer(d3.text, '/ch3/geography/routes/')
        .await(draw_airlines);
};
